...
class NetworkMessageHistoryMapper(private val mapper: MapperManager) :
    ...
    private val gson = GsonBuilder()
        //.registerTypeAdapter(NetworkMessagePayload.Attachment::class.java, attachmentDeserializer())
    ...
    override fun map(id: ChannelId, input: PNFetchMessageItem): DBMessage {
        ...
        return DBMessage(
            ...
            content = messagePayload.content as DBContent?,
            custom = messagePayload.custom as DBContent?,
