...
interface Logger {
    ...
    fun v(t: Throwable?, @NonNls message: String?, vararg args: Any?) {
        log(priority = Log.VERBOSE, t = t, message = message, args = args)
    }
    ...
    fun d(t: Throwable?, @NonNls message: String?, vararg args: Any?) {
        log(priority = Log.DEBUG, t = t, message = message, args = args)
    }
    ...
    fun i(t: Throwable?, @NonNls message: String?, vararg args: Any?) {
        log(priority = Log.INFO, t = t, message = message, args = args)
    }
    ...
    fun w(t: Throwable?, @NonNls message: String?, vararg args: Any?) {
        log(priority = Log.WARN, t = t, message = message, args = args)
    }
    ...
    fun e(t: Throwable?, @NonNls message: String?, vararg args: Any?) {
        log(priority = Log.ERROR, t = t, message = message, args = args)
    }
    ...
    fun wtf(t: Throwable?, @NonNls message: String?, vararg args: Any?) {
        log(priority = Log.ASSERT, t = t, message = message, args = args)
    }

    /** Log an assert message with optional format args */
    fun wtf(@NonNls message: String?, vararg args: Any?) {
        wtf(t = null, message = message, args = args)
    }

    /** Log an assert exception */
    fun wtf(t: Throwable?) {
        wtf(t = t, message = null)
    }
    ...
    fun log(priority: Int, @NonNls message: String?, vararg args: Any?) {
        log(priority = priority, t = null, message = message, args = args)
    }

    /** Log at `priority` an exception */
    fun log(priority: Int, t: Throwable?) {
        log(priority = priority, t = t, message = null)
    }
}